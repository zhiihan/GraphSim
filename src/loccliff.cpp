...
RightMatrix LocCliffOp::get_matrix(void) const {
    const short matrices[24][2][2] = {
        {{0, -1}, {-1, 0}}, {{-1, 0}, {0, -1}}, {{-1, 3}, {1, -1}},
        {{0, -1}, {-1, 2}}, {{-1, 0}, {3, -1}}, {{0, -1}, {-1, 3}},
        {{0, -1}, {-1, 1}}, {{-1, 0}, {1, -1}}, {{0, 2}, {2, 2}},
        {{0, 2}, {0, 0}},   {{0, 0}, {0, 2}},   {{0, 0}, {2, 0}},
        {{0, 1}, {3, 2}},   {{0, 3}, {1, 2}},   {{0, 1}, {1, 0}},
        {{0, 3}, {3, 0}},   {{0, 3}, {0, 1}},   {{0, 1}, {2, 1}},
        {{0, 3}, {2, 3}},   {{0, 1}, {0, 3}},   {{0, 0}, {1, 3}},
        {{0, 0}, {3, 1}},   {{0, 2}, {3, 3}},   {{0, 2}, {1, 1}}};
    RightMatrix rm;
    rm.sqrt2norm = true;
    for (int i = 0; i < 2; i++) {
        for (int j = 0; j < 2; j++) {
